...
urlpatterns = patterns('',
    ...
    url(r'^logout/$', 'library_collection.views.logout_view', name='logout_view'),
    ...
    url(r'^(?P<edit>(edit/|))(?P<colid>\d*)/(?P<col_slug>.*)/$', 'library_collection.views.details', name='edit_detail'),
